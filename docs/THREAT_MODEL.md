...
| Metrics leakage | merchant/privacy | correlation | no high-cardinality labels, `ETH402_METRICS_ENABLED` gate, proxy refuses `/metrics` | schema review | traffic inference |
