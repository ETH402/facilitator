...
- `GET /merchant` and `/merchant/api/*`: first-party merchant administration
  with overview, private analytics, API-key management, and independently
  consented public-profile settings.
